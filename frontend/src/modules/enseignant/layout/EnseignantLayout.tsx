...
export default function EnseignantLayout() {
  ...
  return (
    <div className="h-screen w-full flex bg-gray-50 overflow-hidden">
      ...
      {/* ───────────────────────────────────────────────────── */}
      {/* Sidebar (Thème Bleu/Indigo pour les enseignants) */}
      {/* ───────────────────────────────────────────────────── */}
      <aside
      ...
      >
        ...
        >
          <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-indigo-500 to-blue-600 shadow-lg shadow-indigo-900/40">
          ...
          <div className={`min-w-0 ${sidebarCollapsed ? 'lg:hidden' : ''}`}>
            ...
            <p className="text-[11px] text-indigo-300 leading-tight truncate">
              Portail Enseignant
            </p>
          </div>
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={`absolute left-0 top-1/2 -translate-y-1/2 h-6 w-[3px] rounded-r-full bg-indigo-500 transition-opacity ${
        ...
        >
          <div className="flex items-center gap-3 rounded-lg bg-slate-800/50 p-3 border border-slate-700/50">
            <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-indigo-500 text-xs font-bold text-white">
              Prof
            </div>
              ...
              {profileMenuOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50">
                  <div className="px-4 py-2 border-b border-gray-50">
                    ...
                    <p className="text-xs text-gray-400">prof@smartcampus.ma</p>
                  </div>
  ...
  return (
    <div className="min-h-full bg-gray-50 p-6 md:p-8 flex items-center justify-center">
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center max-w-md">
        <div className="flex h-14 w-14 items-center justify-center rounded-full bg-indigo-50 mx-auto mb-4">
          <Construction className="h-7 w-7 text-indigo-500" />
        </div>
