...
const getStatutBadgeClasses = (statut: StatutConsultation): string => {
  const map: Record<StatutConsultation, string> = {
    ...
    Acceptee: 'bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 border border-green-200 dark:border-green-800',
    ...
    Consultee: 'bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700',
          ...
          <div className="space-y-4">
            ...
            <div
              className={`grid grid-cols-1 sm:grid-cols-2 gap-3 rounded-lg p-3 transition-colors ${
                requiresScheduling ? 'bg-primary-50/50 dark:bg-primary-900/10 border border-primary-100 dark:border-primary-800/50' : ''
              }`}
            >
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-card dark:bg-card-dark px-3 py-2 text-sm text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent disabled:bg-slate-100 dark:disabled:bg-slate-800 disabled:text-slate-400 dark:disabled:text-slate-500"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide mb-1.5 flex items-center gap-1.5">
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-card dark:bg-card-dark px-3 py-2 text-sm text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent disabled:bg-slate-100 dark:disabled:bg-slate-800 disabled:text-slate-400 dark:disabled:text-slate-500"
                />
              </div>
            </div>
              ...
              <tbody className="divide-y divide-slate-200/70 dark:divide-slate-800">
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center">
                      <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary-50 dark:bg-primary-900/30 mx-auto mb-2">
                        <CalendarClock className="h-6 w-6 text-primary-600 dark:text-primary-400" />
                      </div>
                  ...
                  filteredConsultations.map((c) => {
                    ...
                    return (
                      <tr key={c.id_verification} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                        ...
                        <td
                          className="px-6 py-4 text-sm text-slate-600 dark:text-slate-300 max-w-xs truncate"
                          title={c.motif}
                        >
                          {c.motif}
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          {hasScheduling ? (
                            <div className="text-sm text-slate-600 dark:text-slate-300 space-y-1 tabular-nums">
                              <span className="flex items-center gap-1.5">
                                ...
                                <div className="flex h-5 w-5 items-center justify-center rounded bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 ml-1">
                            ...
                            <span className="text-sm text-slate-500 dark:text-slate-400 italic">Non planifiée</span>
                          )}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
