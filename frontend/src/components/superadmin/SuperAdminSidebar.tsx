...
function SidebarContent({
    ...
    return (
        <div className="flex h-full flex-col">
            ...
            >
                <div className="relative flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-rose-500 to-red-600 text-white shadow-lg shadow-rose-500/30">
                    ...
                    return (
                        ...
                        >
                            {({ isActive }) => (
                                <>
                                    {isActive && (
                                        <span className="absolute left-0 top-1/2 h-6 w-1 -translate-y-1/2 rounded-r-full bg-gradient-to-b from-rose-500 to-red-600" />
                                    )}
                                    {isActive && (
                                        <span className="absolute inset-0 rounded-xl bg-gradient-to-r from-rose-50 to-red-50 dark:from-rose-900/20 dark:to-red-900/10" />
                                    )}
                                    <Icon
                                        size={18}
            ...
            <div className="border-t border-slate-200 p-3 dark:border-slate-800">
                <button
                    ...
                    className={`flex w-full items-center rounded-xl py-2.5 text-[13px] font-medium text-slate-500 transition hover:bg-rose-50 hover:text-rose-600 dark:text-slate-400 dark:hover:bg-rose-900/20 ${
