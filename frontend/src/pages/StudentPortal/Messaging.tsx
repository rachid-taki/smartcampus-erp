...
export default function Messaging() {
    ...
    // UN SEUL useEffect pour charger les conversations (le bon)
    useEffect(() => {
        const load = async () => {
            try {
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <p className="text-[11px] text-slate-500 dark:text-slate-400">
                                                Service de la scolarité · En ligne
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    >
                        ...
                        <div className="border-t border-slate-200 bg-white p-3 dark:border-slate-800 dark:bg-slate-900">
                            ...
                            <p className="mt-2 text-center text-[10px] text-slate-400 dark:text-slate-500">
                                Appuyez sur <kbd className="rounded bg-slate-100 px-1 py-0.5 text-[9px] font-semibold dark:bg-slate-800">Entrée</kbd> pour envoyer, <kbd className="rounded bg-slate-100 px-1 py-0.5 text-[9px] font-semibold dark:bg-slate-800">Maj+Entrée</kbd> pour un saut de ligne
                            </p>
                        </div>
                        </>
                    )}
