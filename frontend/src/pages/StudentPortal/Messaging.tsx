...
export default function Messaging() {
    ...
    return (
        <div className="animate-fade-in flex h-[calc(100vh-6rem)] flex-col overflow-hidden">
            <div className="flex items-center gap-2.5 pb-3">
                ...
                {totalUnread > 0 && (
                    <motion.span
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        className="inline-flex h-4 items-center rounded-full bg-primary-600 px-1.5 text-[9px] font-bold text-white"
                    >
            ...
            <div className="card flex flex-1 overflow-hidden p-0">
                <aside
                    ...
                    } w-full flex-col border-r border-slate-200 dark:border-slate-800 md:w-[320px] md:shrink-0`}
                >
                    <div className="border-b border-slate-200 px-3.5 py-2.5 dark:border-slate-800">
                        <div className="mb-2.5 flex items-center justify-between">
                            ...
                            <button
                                ...
                                className="flex h-7 w-7 items-center justify-center rounded-lg bg-primary-600 text-white transition hover:bg-primary-700 active:scale-95"
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full rounded-lg border border-slate-200 bg-white py-1.5 pl-8 pr-3 text-[11px] text-slate-700 placeholder:text-slate-400 focus:border-primary-400 focus:outline-none dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200"
                            />
                        </div>
                    </div>
                            ...
                            <div className="flex flex-col items-center gap-2 px-5 py-10 text-center">
                                ...
                                {!searchQuery && (
                                    <button
                                        type="button"
                                        onClick={() => setShowNewModal(true)}
                                        className="mt-1.5 inline-flex items-center gap-1 rounded-lg bg-primary-600 px-2.5 py-1 text-[10px] font-semibold text-white hover:bg-primary-700"
                                    >
                                        <Plus size={11} />
                                        Créer
                                    </button>
                                ...
                                {filteredConversations.map((conv) => (
                                    ...
                                    >
                                        <div className="relative shrink-0">
                                            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-primary-500 to-primary-600 text-white shadow-sm">
                                                <GraduationCap size={15} />
                                            </div>
                                            {conv.nonLus > 0 && (
                                                <span className="absolute -right-0.5 -top-0.5 flex h-4 min-w-[16px] items-center justify-center rounded-full bg-rose-500 px-1 text-[9px] font-bold text-white ring-2 ring-white dark:ring-slate-900">
                                                    {conv.nonLus}
                                                </span>
                                            )}
                                        </div>
                                        <div className="min-w-0 flex-1">
                                            <div className="flex items-center justify-between gap-1.5">
                                                ...
                                                {conv.derniereActivite && (
                                                    <span className="shrink-0 text-[9px] font-medium text-slate-400 tabular-nums">
                ...
                >
                    {!activeConv ? (
                        <div className="flex flex-1 flex-col items-center justify-center gap-3 p-6 text-center">
                            <div className="relative">
                                <div className="absolute -inset-3 animate-pulse rounded-full bg-primary-100/50 dark:bg-primary-900/20" />
                                <div className="relative flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary-500 to-primary-700 text-white shadow-lg shadow-primary-500/30">
                            ...
                            <button
                                type="button"
                                onClick={() => setShowNewModal(true)}
                                className="mt-1.5 inline-flex items-center gap-1.5 rounded-lg bg-primary-600 px-4 py-2 text-[12px] font-semibold text-white shadow-sm transition hover:bg-primary-700 active:scale-[0.98]"
                            >
                                <Plus size={14} />
                        ...
                        <>
                            <div className="flex items-center justify-between border-b border-slate-200 px-4 py-2.5 dark:border-slate-800">
                                <div className="flex items-center gap-2.5">
                                    <button
                                        ...
                                        className="flex h-7 w-7 items-center justify-center rounded-lg text-slate-500 transition hover:bg-slate-100 md:hidden dark:hover:bg-slate-800"
                                    >
                                        <ArrowLeft size={16} />
                                    </button>
                                    <div className="relative">
                                ...
                                <span className="hidden rounded-full bg-slate-100 px-2 py-0.5 text-[9px] font-semibold uppercase tracking-wider text-slate-600 sm:inline-flex dark:bg-slate-800 dark:text-slate-300">
                                    {activeConv.statut}
                                </span>
                            </div>
                            ...
                            <div
                                ref={scrollRef}
                                className="flex-1 space-y-0.5 overflow-y-auto bg-gradient-to-b from-slate-50/50 to-white px-4 py-3 dark:from-slate-900/50 dark:to-slate-900"
                            >
                                {loadingMsgs && messages.length === 0 ? (
                                    ...
                                    <div className="flex h-full flex-col items-center justify-center gap-2 py-8 text-center">
                                        ...
                                        <p className="max-w-xs text-[10.5px] text-slate-500 dark:text-slate-400">
                                                ...
                                                <div key={msg.id}>
                                                    ...
                                                    >
                                                        {!msg.isMine && !isGroupedWithPrev && (
                                                            <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-primary-500 to-primary-600 text-white shadow-sm">
                                                                <Users size={11} />
                                                            </div>
                                                        )}
                                                        {!msg.isMine && isGroupedWithPrev && (
                                                        ...
                                                        <div
                                                            className={`flex max-w-[75%] flex-col space-y-0.5 ${
                                                        ...
                                                        >
                                                            ...
                                                            <div
                                                                className={`rounded-2xl px-3 py-2 text-[12px] leading-relaxed shadow-sm ${
                                                                    msg.isMine
                                                                ...
                                                                <div className="mt-1 flex flex-wrap gap-1">
                                                                    {msg.piecesJointes.map((pj) => (
                                                                        <button
                                                                            ...
                                                                            className={`group inline-flex cursor-pointer items-center gap-1.5 rounded-lg border px-2.5 py-1.5 text-[10.5px] font-medium transition hover:shadow-sm ${
                                                                                msg.isMine
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <div className="text-left">
                                                                                <p className="max-w-[140px] truncate font-semibold">
                                                                                    {pj.nom}
                                                                                </p>
                                                                                <p
                            ...
                            {typingUsers.size > 0 && (
                                <div className="flex items-center gap-1.5 px-4 py-1">
                                    <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-br from-primary-500 to-primary-600 text-white">
                                        <Users size={9} />
                                    </div>
                            ...
                            <div className="border-t border-slate-200 bg-white p-2.5 dark:border-slate-800 dark:bg-slate-900">
                                    ...
                                    <div className="mb-1.5 flex flex-wrap gap-1.5">
                                        {attachedFiles.map((f, i) => (
                                            <motion.div
                                                ...
                                                className="inline-flex items-center gap-1 rounded-lg border border-slate-200 bg-slate-50 px-2 py-1 text-[10px] font-medium text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200"
                                            >
                                                ...
                                                <button
                                                    ...
                                                    className="flex h-3.5 w-3.5 items-center justify-center rounded-full text-slate-400 hover:bg-slate-200 hover:text-slate-600 dark:hover:bg-slate-700"
                                                >
                                                    <X size={9} />
                                                </button>
                                            </motion.div>
                                ...
                                <div className="flex items-end gap-1.5 rounded-xl border border-slate-200 bg-white px-2.5 py-1.5 dark:border-slate-700 dark:bg-slate-800">
                                    <button
                                        type="button"
                                        onClick={() => fileInputRef.current?.click()}
                                        className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-slate-500 transition hover:bg-slate-100 hover:text-primary-600 dark:hover:bg-slate-700 dark:hover:text-primary-400"
                                    ...
                                    <textarea
                                        ...
                                        className="max-h-24 flex-1 resize-none border-0 bg-transparent py-1.5 text-[12px] text-slate-800 placeholder:text-slate-400 outline-none dark:text-slate-100 dark:placeholder:text-slate-500"
                                    ...
                                    <button
                                        ...
                                        className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-primary-600 text-white shadow-sm transition hover:bg-primary-700 disabled:cursor-not-allowed disabled:opacity-40 active:scale-95"
                                    >
                                        {sending ? (
                                ...
                                <p className="mt-1.5 text-center text-[9px] text-slate-400 dark:text-slate-500">
                                    Appuyez sur{" "}
                                    <kbd className="rounded bg-slate-100 px-0.5 py-0.5 text-[8px] font-semibold dark:bg-slate-800">
                                        Entrée
                                    </kbd>{" "}
                                    pour envoyer,{" "}
                                    <kbd className="rounded bg-slate-100 px-0.5 py-0.5 text-[8px] font-semibold dark:bg-slate-800">
            ...
            <AnimatePresence>
                {showNewModal && (
                    ...
                    >
                        ...
                        >
                            <div className="flex items-center gap-2.5 border-b border-slate-200 px-5 py-3 dark:border-slate-800">
                            ...
                            <div className="p-5">
                                ...
                                <input
                                    ...
                                    className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-[12px] text-slate-700 placeholder:text-slate-400 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-100 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:placeholder:text-slate-500 dark:focus:ring-primary-900/30"
                                />
                                <div className="mt-4 flex justify-end gap-1.5">
                                    <button
                                        type="button"
                                        onClick={() => setShowNewModal(false)}
                                        className="rounded-lg border border-slate-200 bg-white px-3.5 py-1.5 text-[12px] font-semibold text-slate-600 transition hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
                                    >
                                        Annuler
                                    </button>
                                    <button
                                        ...
                                        className="rounded-lg bg-primary-600 px-3.5 py-1.5 text-[12px] font-semibold text-white transition hover:bg-primary-700 disabled:cursor-not-allowed disabled:opacity-50"
                                    >
