...
export default function Login() {
  ...
  { title: "Réclamation de note",desc: "les Réclamations concernant vos notes des exams."},
  { title: "Convention de stage" ,desc: "demander votre convention de stage."},
  { title: "Demande de bourse",desc: "bourse et plus ."},
  {title: "contacter votre RH",desc: "le contact avec votre RH et plus fluid."},
  {title: "workflow demandes administrative",desc: "suive vos demandes et son etat ."},
];
    ...
    >
      ...
      <div className="hidden lg:flex sc-panel w-[46%] flex-col justify-between p-14 text-white">
        ...
        <div className="relative z-10">
          <p className="text-xs uppercase tracking-widest mb-6" style={{ color: "#8CA3D6" }}>
          </p>
          {isLogin ? (
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="flex lg:hidden items-center gap-3 mb-8">
            <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ background: "#071433" }}>
              <GraduationCap size={18} color="#8FC4FB" />
            </div>
            <p className="sc-display text-xl" style={{ color: "#071433" }}>SmartCampus ERP</p>
          </div>

          <div
            className="rounded-3xl p-9"
            style={{ background: "#FFFFFF", boxShadow: "0 24px 60px -20px rgba(15,35,90,0.18)" }}
          >
            {/* Tabs */}
            <div
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <button
                ...
                style={{
                  border: role === "etudiant" ? "1.5px solid #2451E0" : "1.5px solid #DCE5F5",
                  background: role === "etudiant" ? "rgba(36,81,224,0.08)" : "transparent",
              ...
              <button
                ...
                className="sc-chip flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-medium"
                style={{
                  border: role === "personnel" ? "1.5px solid #2451E0" : "1.5px solid #DCE5F5",
                  background: role === "personnel" ? "rgba(36,81,224,0.08)" : "transparent",
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="text-xs font-medium" style={{ color: "#4B5165" }}>
              ...
              {!isLogin && (
                <div>
                  ...
                  <div className="sc-field flex items-center rounded-xl mt-1.5 px-3.5">
                    ...
                    <input
                      type="text"
                      placeholder={role === "etudiant" ? "Ex. J123456789" : "Ex. PR-00214"}
